        ...
        <div class="col-md-6 col-md-offset-3 col-sm-5 col-sm-offset-4">
            <div class="panel panel-primary" style="margin-top: 90px;">
                ...
                <div class="panel-body">
                        ...
                        <select id="district_select" class="form-control" name="state" required="">   
                            <option value="-1" disabled selected>Select District</option>                        
                        </select>
                        
                        <label for="statename"> Add New Place</label>
                        <input type="text" id="add_place" class="form-control" name="add_state" placeholder="New Place Name" required="">                         

                        <center><input type="button" class="btn btn-primary m-t-10" id="add" name="add" value="Add Place" style="margin-top: 5px;"></center>
                        ...
                        <select id="district_edit_select" class="form-control" name="state" required="">   
                         ...
                         <label for="states" class="m-t-10">Select your Place</label>
                        <select id="place_edit_select" class="form-control" name="state" required="">   
